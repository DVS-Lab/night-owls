...
#first screen
instruct_screen = visual.TextStim(win, text='Please use the keyboard to answer the following questions about your partners. Press 1 to move left, 3 to move right, and 2 to select.', pos = (0,0), units='norm', height = 0.1)
