...
if ~isempty(practice_files)                             % checks to see whether there is practice data or not. Overwrite if there is
    load(practice_files(end,1:end-0),'RTs'); % practice_files has an extra space character added to the string name, hence the 1:end-1 in the code
end
...
% Changing loss trials to win, will be two practice trials per condition
