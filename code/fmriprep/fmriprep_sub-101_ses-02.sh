...
singularity run --cleanenv \
	...
	-B $maindir/scratch/ses-02:/scratch \
	/gpfs/scratch/tug87422/smithlab-shared/tools/fmriprep-24.1.1.simg \
	/base/bids /base/derivatives/ses-02 \
	...
	--bids-filter-file /base/code/fmriprep/fmriprep_config_sub-101_ses-02.json \
