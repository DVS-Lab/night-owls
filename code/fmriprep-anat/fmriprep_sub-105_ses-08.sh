...
singularity run --cleanenv \
	...
	-B $maindir/scratch/anat-ses-08:/scratch \
	/gpfs/scratch/tug87422/smithlab-shared/tools/fmriprep-24.1.1.simg \
	/base/bids /base/derivatives/anat-only/ses-08 \
	participant --participant_label sub-105 \
	--stop-on-first-crash \
  ...
  --derivatives /gpfs/scratch/tug87422/smithlab-shared/night-owls/derivatives/anat-only \
	--bids-filter-file /base/code/fmriprep-anat/fmriprep_config_sub-105_ses-08.json \
